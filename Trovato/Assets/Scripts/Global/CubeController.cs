...
public class CubeController : MonoBehaviour {
	...
	public int CubeMode; // 魔方的層數
	public GameObject CubeHome; // 魔方塊們的群組
	public GameObject CubeLeader; // 帶領魔方轉動的群組
	public GameObject GhostWall_V2; // 魔方V2的隱形牆
	public GameObject GhostWall_V3; // 魔方V3的隱形牆
